(async () => {
  ...
  if (iconUrl) { const img = document.createElement('img'); img.src = iconUrl; img.alt = ''; open.textContent = ''; open.append(img); }
  let history = [];
  let greeted = false;
